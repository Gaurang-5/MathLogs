...
import { addStudentManually, approveStudent, getClassAverageStats, getPendingStudents, getStudentGrowthStats, registerStudent, rejectStudent, updateStudent, getStudentProfile } from '../controllers/studentController';
...
router.get('/students/:id/profile', authenticateToken, getStudentProfile);
// Students
// Stickers
