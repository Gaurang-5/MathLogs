...
export default function Billing() {
    ...
    const maxStudents = config.maxStudents || (institute?.plan === 'PRO' ? 250 : 100);
                ...
                handler: async (response: RazorpayHandlerResponse) => {
                    try {
                        ...
                        if (verifyRes.success) {
                            toast.success('Payment verified! Your plan has been renewed.');
                            fetchInstituteDetails();
                        } else {
    ...
    // Get display price for custom plan based on current billing cycle
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row justify-between md:items-center gap-4">
                                <div>
                                    ...
                                    <h4 className="text-3xl font-black flex items-center gap-3 !text-white dark:!text-black">
                                        {currentPlanName}
                                        {isCustomPlan && (
                                            <span className="text-xs font-bold bg-gradient-to-r from-amber-400 to-orange-500 text-black px-2.5 py-1 rounded-md uppercase tracking-wide flex items-center gap-1">
                                                <Crown className="w-3 h-3" /> Custom
                                            </span>
                                        )}
                                    ...
                                    <p className="opacity-80 mt-2 text-sm">
                                        You are currently allowed up to <strong className="text-white dark:text-black">{maxStudents} students</strong> in your institute.
                                    </p>
                                ...
                                <div className="flex flex-col gap-2 min-w-[200px]">
                                    {/* Custom plans: only show Renew, no Upgrade */}
                                    {isCustomPlan ? (
                                        <button 
                                            onClick={() => {
                    ...
                    {isCustomPlan ? (
                        <>
                            <div className="mb-8 pl-1">
                                <h2 className="text-xl font-bold tracking-tight mb-2">Renew Your Custom Plan</h2>
                                <p className="text-app-text-tertiary text-sm">Your plan has been specially configured. Select your billing cycle and renew below.</p>
                            </div>
                            ...
                            <div className="max-w-md mx-auto mb-8">
                                <div className="relative p-6 rounded-3xl border-2 border-black bg-white shadow-xl">
                                    <div className="absolute top-0 right-6 bg-gradient-to-r from-amber-400 to-orange-500 text-black text-[10px] font-bold uppercase tracking-widest py-1 px-3 rounded-b-lg flex items-center gap-1">
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <p className="text-app-text-secondary mt-2 font-medium text-xs leading-relaxed">
                                            A plan specially configured for your institute by the administrator.
                                        </p>
                                    </div>
                                    ...
                                    <div className="mt-6 w-full py-3 rounded-xl font-bold text-sm text-center bg-black text-white">
                                        Selected
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-black text-white rounded-3xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden relative">
                                <div className="absolute right-0 top-0 w-64 h-64 bg-amber-500/20 blur-[100px] rounded-full pointer-events-none" />
                                ...
                                <div className="relative z-10 w-full md:max-w-md">
                                    ...
                                    <p className="text-neutral-400 font-medium text-sm leading-relaxed mb-4">
                                        You're renewing your <span className="text-white font-bold">Custom Plan</span> ({billingCycle}).
                                        Your access will be extended accordingly.
                                    </p>
                                </div>
                        ...
                        /* STANDARD PLAN PICKER (Basic/Pro) */
                        <>
                            <div className="mb-8 pl-1">
