                        ...
                        <div className="bg-app-surface-opaque border border-app-border p-8 rounded-[24px] shadow-xl">
                            ...
                            <form onSubmit={handleCreate} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="md:col-span-2 flex justify-end pt-4">
                                    <button type="submit" className="bg-gray-900 hover:bg-black text-white px-8 py-3.5 rounded-xl font-semibold shadow-lg shadow-gray-200 transition-all hover:scale-[1.02] active:scale-95">
                                        Create & Start
                                    </button>
                                </div>
                            </form>
